...
$seo_title          = $header_title . '. Результаты матчей. ' . $seo_title;
$seo_description    = $header_title . '. Результаты матчей. ' . $seo_description;
$seo_keywords       = $header_title . ', результаты матчей, ' . $seo_keywords;
