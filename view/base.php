    ...
    <tr>
        <td class="block-page">
            ...
            <?php } elseif (isset($level) && 1 == $level) { ?>
                ...
                <p class="center">
                    <button><a href="base.php?level=1&ok=1">Начать строительство</a></button>
                    <button><a href="base.php">Отказаться от строительства</a></button>
                </p>
            <?php } elseif (isset($level) && 0 == $level) { ?>
                ...
                <p class="center">
                    <button><a href="base.php?level=0&ok=1">Провести строительство</a></button>
                    <button><a href="base.php">Отказаться от строительства</a></button>
                </p>
            <?php } else { ?>
