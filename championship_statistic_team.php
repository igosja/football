...
$seo_title          = $tournament_name . '. Статистика команд. ' . $seo_title;
$seo_description    = $tournament_name . '. Статистика команд. ' . $seo_description;
$seo_keywords       = $tournament_name . ', статистика команд, ' . $seo_keywords;
