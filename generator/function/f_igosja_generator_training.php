...
//Тренировка игроков
{
    ...
    for ($i=0; $i<$count_player; $i++)
    {
        ...
        $percent            = round($training_level * $reputation * $ability / 10000, 2) * 2;
        $training_percent   = round($percent * $intensity / 10, 2);
        ...
        $percent = round(($percent - $percent_minus) / TRAINING_ATTRIBUTES_COUNT, 2);
