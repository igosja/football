                ...
                <tr>
                    <td class="block-page w100">
                        ...
                        <table class="striped w100">
                            <?php for ($i=0; $i<2; $i++) { ?>
                                <tr>
                                    <td class="w50"><?php print $record_array[$i]['recordcountrytype_name']; ?></td>
                                    <td>
                                        <?php print $record_array[$i]['recordcountry_value']; ?> в
                                        <a href="tournament_review_profile.php?num=<?php print $record_array[$i]['tournament_id']; ?>">
                                            <?php print $record_array[$i]['tournament_name']; ?>
                                        </a>
                                    </td>
                                </tr>
                            <?php } ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="game_review_main.php?num=<?php print $record_array[$i]['game_id']; ?>">
                                            <?php print $record_array[$i]['recordcountry_value']; ?>
                                        </a>
                                        (<?php print f_igosja_ufu_date($record_array[$i]['shedule_date']); ?>)
                                    </td>
                                </tr>
                            <?php } ?>
                        </table>
                        ...
                        <table class="striped w100">
                            <?php for ($i=11; $i<$count_record; $i++) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php print $record_array[$i]['recordcountry_value']; ?>
                                        (<?php print f_igosja_ufu_date($record_array[$i]['recordcountry_date_start']); ?> -
                                        <?php print f_igosja_ufu_date($record_array[$i]['recordcountry_date_end']); ?>)
                                    </td>
                                </tr>
                            <?php } ?>
                        </table>
