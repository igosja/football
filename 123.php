...
$message = 'Здравствуйте, Игося.<br/>Рады сообщить вам, что сайт ' . $_SERVER['HTTP_HOST'] . ' начинает свою работу, вы можете войти на сайт используя свой логин и пароль и взять под свое управление поднравившуюся команду.';
