...
$seo_title          = $tournament_name . '. Статистика судей. ' . $seo_title;
$seo_description    = $tournament_name . '. Статистика судей. ' . $seo_description;
$seo_keywords       = $tournament_name . ', статистика судей, ' . $seo_keywords;
