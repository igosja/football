                ...
                <table class="striped w100">
                    ...
                    <?php foreach ($player_array as $item) { ?>
                        <tr>
                            ...
                            <td class="nopadding">
                                <select class="w100" name="data[<?= $item['player_id']; ?>][position]">
                            ...
                            <td class="nopadding">
                                <select class="w100" name="data[<?= $item['player_id']; ?>][attribute]">
                                    <option value="0">Не выбрано</option>
                                    <?php if (1 == $item['position_id']) { ?>
                            ...
                            <td class="center nopadding">
                                <select class="w100" name="data[<?= $item['player_id']; ?>][intensity]">
                                    <option
                                        value="1"
