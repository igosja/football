...
$seo_title          = $header_title . '. Статистика клубов. ' . $seo_title;
$seo_description    = $header_title . '. Статистика клубов. ' . $seo_description;
$seo_keywords       = $header_title . ', статистика клубов, ' . $seo_keywords;
